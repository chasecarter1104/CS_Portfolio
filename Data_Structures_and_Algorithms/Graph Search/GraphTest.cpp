...
bool testFindVertexPos();
bool testVertexExists();
...
int main(int argc, char** argv){
   ...
   switch(test){
      case 0:
         ...
         // MY ADDED TESTS
         if (testFindVertexPos()) count++;
         if (testVertexExists()) count++;
         cout << "Passed " << count << " out of 4 tests";
         return count != 4;
      case 1:
...
bool testFindVertexPos() {
    ...
    cout << "\nFind Vertex Position Test Cases" << endl;
    passed &= checkCase("Vertex Position 'a'", g.findVertexPos('a') == 9); // 'a' should be at position 9
    passed &= checkCase("Vertex Position 'e'", g.findVertexPos('e') == 5); // 'e' should be at position 5
    passed &= checkCase("Vertex Position 'z'", g.findVertexPos('z') == -1); // 'z' should not be found in the graph
...
bool testVertexExists() {
    ...
    cout << "Vertex Exists Test Cases" << endl;
    passed &= checkCase("Vertex Exists 'a'", g.vertexExists('a'));
    passed &= checkCase("Vertex Exists 'e'", g.vertexExists('e'));
    passed &= checkCase("Vertex Exists 'z'", !g.vertexExists('z'));
